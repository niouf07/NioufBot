...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (amount <= 0) {
      return interaction.reply({
        content: "You must give a positive amount of experience points.",
        flags: 64,
      });
    }
          ...
          (err2, results) => {
            ...
            db.query(
              ...
              (err3) => {
                if (err3) {
                  console.error(
                    "Failed to update user experience/level:",
                    err3
                  );
                  return interaction.reply({
                    content: "Failed to update user experience/level.",
                    flags: 64,
                  });
                }
                if (leveledUp) {
                  ...
                  return interaction.reply({
                    content: `Gave ${amount} XP to <@${userID}>.`,
                  });
                }
              }
            );
